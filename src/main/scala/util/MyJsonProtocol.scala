...
object MyJsonProtocol extends DefaultJsonProtocol {
  ...
  implicit val postFormat = jsonFormat7(F_Post.apply)
  implicit val postEFormat = jsonFormat7(F_PostE.apply)
  implicit val pictureFormat = jsonFormat8(F_Picture.apply)
  implicit val pictureEFormat = jsonFormat8(F_PictureE.apply)
