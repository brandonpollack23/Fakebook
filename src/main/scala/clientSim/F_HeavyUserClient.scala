...
class F_HeavyUserClient() extends Actor with ActorLogging{

  log.info("=> *Heavy Client* Logging Started")
  ...
  def receive ={
    ...
    */
    case Simulate =>
      ...
      system.scheduler.schedule(0 milliseconds, 100 milliseconds )(self ! PerformAction)
