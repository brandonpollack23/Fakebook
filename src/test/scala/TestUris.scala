...
trait TestUris {
  ...
  val createUserSuccessRequest = Put(Uri(testDomain + "/users/newuser") withQuery(F_User.lastNameString -> "Pollack", F_User.firstNameString -> "Brandon", F_User.bioString -> "i like foobar",
